...
logo= ("""\x1b[38;5;197m(WELCOME TO SAIKO HACKER TEAM )


   _____       _    _     _______   _____    __  __ 
  / ____|     | |  | |   |__   __| |  __ \  |  \/  |
 | (___ ______| |__| |______| |    | |__) | | \  / |
  \___ \______|  __  |______| |    |  _  /  | |\/| |
  ____) |     | |  | |      | |    | | \ \ _| |  | |
...
def main():
    ...
    print(f'\x1b[38;5;155m➤  [1] S-H-T R.M ')

    print(f'\x1b[38;5;155m➤  [2] FUCK YOU ');linex()

    t=input('\x1b[38;5;155m[➤] CEO R.M RONY : ')
...
def bhoot():
    ...
    code = input(f'\x1b[38;5;155m[➤] FUCK YOU : ');linex()
    ...
    with ThreadPool(max_workers=30) as RONY:
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] S-H-T RM~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
